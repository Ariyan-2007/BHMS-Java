...
public class FOSignup extends JFrame
{
    ...
    public class HandlerClass implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
                        if(event.getSource()==signup2)
                        {
                            ...
                            String filename = ".txt";
                            File foAcc = new File("C:\\BHMS\\src\\main\\java\\Boot\\FlatOwner_Acc\\" + user.getText() + filename);
                            ...
                            else
                            {
                                ...
                                String balance = "Balance: 10000";
                                String fullString = "Fullname: ";
                                String passString = "Password: ";
                            
                                FileWriter foAccount = new FileWriter("C:\\BHMS\\src\\main\\java\\Boot\\FlatOwner_Acc\\" + user.getText() + filename);
                                
                                foAccount.write(passString);
                                pass.write(foAccount);
                                foAccount.write(System.getProperty("line.separator"));
                                foAccount.write(fullString);
                                first.write(foAccount);
                                foAccount.write(" ");
                                last.write(foAccount);
                                foAccount.write(System.getProperty("line.separator"));
                                foAccount.write(balance);
                                foAccount.close();
